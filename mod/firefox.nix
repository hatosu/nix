...
profiles.hatosu = { isDefault = true;
      ...
      bookmarks = let name = ""; in [ { name = "toolbar"; toolbar = true; bookmarks = [
        { url = "https://web.archive.org/"; inherit name; }
        { url = "https://bookmeter.com/home"; inherit name; }
        { url = "https://community.flake.parts/haskell-flake"; inherit name; }
        ...
        { url = "https://annas-archive.org/search?index=&page=1&q=%E3%82%B0%E3%82%A4%E3%83%B3%E3%83%BB%E3%82%B5%E3%83%BC%E3%82%AC1&display=&sort="; inherit name; }
